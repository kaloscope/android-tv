...
客户端连接到用户自行部署的服务端，提供媒体库浏览、网络资源搜索，以及电视端视频播放、图片与文本阅读能力。
...
- 网络搜索结果支持视频播放，以及图片和文本资源阅读
- 图片阅读支持连续滚动、单页翻页、缩放和翻页方向；文本阅读支持主题、字体、字号和版式调整
- 视频播放支持本地媒体和网络资源，兼容渐进式媒体、HLS 与 DASH
- 本地媒体支持直连、HLS 转码及自动回退策略
- 本地媒体支持播放进度记录和续播；播放器支持章节、选集、字幕、倍速和自动连播
- 支持弹幕显示、类型屏蔽、字号、速度、透明度和显示区域设置
- 支持主题色、默认启动页、播放模式、转码清晰度、字幕和阅读器偏好等客户端设置
